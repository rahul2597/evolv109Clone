...
const Servicesoffer = ({
  ...
  return (
    <>
      <div className="border-[0.3px] border-slate-800 text-slate-500 rounded-2xl p-5 bg-slate-900 flex items-center justify-center py-10 px-6 hover:bg-red-500 hover:text-white">
